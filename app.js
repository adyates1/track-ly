...
const importedVariables = require("/home/ubuntu/configFile.js");
const clientID = importedVariables.exportedClientID;
const clientSecret = importedVariables.exportedSecret;
const redirectURI = importedVariables.exportedURI;
const encodedClientIDAndSecret = new Buffer(clientID + ':' + clientSecret).toString('base64');

// HTTPS Server Setup
const privateKeyFileLocation = '/home/ubuntu/private-key.pem';
const certificateFileLocation = '/home/ubuntu/www_track-ly_com.crt';
const certificateOptions = {
    key: fs.readFileSync(privateKeyFileLocation),
    cert: fs.readFileSync(certificateFileLocation)
};
const httpsServer = https.createServer(certificateOptions, app);
const io = require('socket.io')(httpsServer);
httpsServer.listen(443, function () {
    console.log("Track-ly, running Express & HTTPS listening on port 443")
});
